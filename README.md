# VKMusix [![PyPI version](https://d25lcipzij17d.cloudfront.net/badge.svg?id=py&r=r&ts=1683906897&type=6e&v=3.4.0&x2=0)](https://pypi.org/project/vkmusix)
...
**• Доступ к текстам треков и функция для их загрузки в MP3, а также обложкам в формате JPG для альбомов и плейлистов**
